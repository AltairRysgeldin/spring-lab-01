...
public class Lab2Controller {
    ...
    public Lab2Controller(NotificationService notifications,
                          ...
                          @Qualifier("rot13") Notifier customNotifier) {
    ...
    @GetMapping("/custom")
    public Map<String, String> custom(@RequestParam String text) {
        return Map.of("original", text, "encrypted", customNotifier.send(text));
    }
}